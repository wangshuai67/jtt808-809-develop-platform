...
import org.ssssssss.jtt809.common.config.ProtocalVersionConfig;
...
import org.ssssssss.jtt809.common.util.RandomUtils;
...
public class JT809Packet0x1202 extends JT809BasePacket {
    ...
    public void setVehicleColor(byte vehicleColor) { this.vehicleColor = vehicleColor; }
    public short getDataType() { return dataType; }
    ...
    public byte getExcrypt() { return excrypt; }
    public void setExcrypt(byte excrypt) { this.excrypt = excrypt; }
    ...
    public short getVec1() { return vec1; }
    public void setVec1(short vec1) { this.vec1 = vec1; }
    public short getVec2() { return vec2; }
    public void setVec2(short vec2) { this.vec2 = vec2; }
    public int getVec3() { return vec3; }
    public void setVec3(int vec3) { this.vec3 = vec3; }
    ...
    public void setAltitude(short altitude) { this.altitude = altitude; }
